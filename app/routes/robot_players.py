...
#     # ✅ Step 2: Only continue if robot member update was successful
...
#         return ResponseDto.error(message="Member Account already exist", statusCode=200, data=[])
...
#             total_register = find_player_dashboard.total_register
#             find_player_dashboard.total_register = total_register + 1
#             try:
#                 db_dataplayer.commit()
#             except SQLAlchemyError as e:
#                 db_dataplayer.rollback()
...
#     return ResponseDto.success(data=[], message="Successfully updated robot and created new member account")
